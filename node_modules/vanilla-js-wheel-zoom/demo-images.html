...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        function summary(wzoom) {
            var $summary = wzoom.viewport.$element.querySelector('div');
            var content = wzoom.content;

            var x = content.currentLeft;
            var y = content.currentTop;
            var scale = content.currentScale;

            $summary.innerHTML = 'x: ' + x.toFixed(2) + ', y: ' + y.toFixed(2) + ', scale: ' + scale.toFixed(2);
        }
